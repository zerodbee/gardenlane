...
<?php
    ...
    ?>
        ...
        <div class="katalog1">
            ...
            <div class="catt3">
                    <ul class="ppp3">
                            <p class="nazvanie1">Композиции</p>
        ...
        <div class="katalog2">
                ...
                <div class="catt4">
                    <ul class="ppp3">
                        <p class="nazvanie1">Съедобные букеты</p>
                ...
                <div class="catt5">
                    <ul class="ppp3">
                        <p class="nazvanie1">Воздушные шары</p>
                ...
                <div class="catt6">
                    <ul class="ppp3">
                        <p class="nazvanie1">Открытки и игрушки</p>
